...
export function RankingsWorkspace({ scores, scoreDate, previousScoreDate, previousScores }: { scores: DatedScore[]; scoreDate: string; previousScoreDate?: string; previousScores: DatedScore[] }) {
