...
- P0.1: record scope, audience, benchmark, target, costs, and exclusions.
...
- P1.1: initialize web, research, and shared-contract boundaries.
- P1.2: define data contracts for securities, prices, filings, and scores.
...
- P4.1: create sector-aware percentile ranks.
...
- P6.1: build idempotent end-of-day score generation.
